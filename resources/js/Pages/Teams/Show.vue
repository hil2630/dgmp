...
<template>
    <AppLayout title="Team Settings">
        ...
        <div class="relative w-full overflow-hidden shadow-xl">
            <img class="absolute inset-0 object-cover w-full h-72 sm:h-96" src="https://bnetcmsus-a.akamaihd.net/cms/blog_thumbnail/9k/9K28JRG5Z8V81717003856942.png" alt="Team background">
            <div class="absolute inset-0 bg-gradient-to-b from-gray-900/90 via-gray-900/60 to-gray-900/30 backdrop-blur-sm"></div>
            <div class="relative z-10 flex flex-col items-center justify-center text-center h-72 sm:h-96">
                <div class="flex flex-col items-center justify-center">
                    <div class="flex items-center justify-center w-24 h-24 mb-4 border-4 border-indigo-500 rounded-full shadow-lg bg-white/10">
                    ...
                    <span class="inline-block px-5 py-2 mt-4 text-base font-semibold text-white bg-indigo-600 rounded-full shadow-lg">
                    ...
                    <div class="lg:col-span-1">
                        <div class="overflow-hidden bg-white shadow dark:bg-gray-800 sm:rounded-lg">
                            <div class="p-6">
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update your team's basic information</p>
                                <div class="mt-6">
                        ...
                        <div v-if="permissions.canDeleteTeam && !team.personal_team" class="mt-8">
                            <div class="overflow-hidden shadow bg-red-50 dark:bg-red-900/20 sm:rounded-lg">
                                <div class="p-6">
                                    ...
                                    <p class="mt-1 text-sm text-red-500 dark:text-red-400">Permanently delete your team and all of its data</p>
                                    <div class="mt-6">
